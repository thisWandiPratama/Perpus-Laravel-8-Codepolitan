!(function (t) {
  ...
  function s (s) {
    ...
    return t ('[data-notify="container"]').each (function (i, n) {
      var a = t (n),
        ...
        l =
          o ===
          t ('<div>' + s.settings.content.title + '</div>').html ().trim (),
        d =
          r ===
          t ('<div>' + s.settings.content.message + '</div>').html ().trim (),
  ...
  (String.format = function () {
    ...
    init: function () {
      var t = this;
      this.buildNotify (), this.settings.content.icon && this.setIcon (), '#' !=
        this.settings.content.url &&
            ...
            switch (n) {
              case 'type':
                this.$ele.removeClass (
                  ...
                  .removeClass (
                    'progress-bar-' + t.settings.type
                  ), (t.settings.type = i[n]), this.$ele
                  .addClass ('alert-' + i[n])
                  .find ('[data-notify="progressbar"] > .progress-bar')
              ...
              case 'progress':
                ...
                this.$ele.data ('notify-delay', o), this.$ele
    ...
    placement: function () {
      ...
      switch ((t (
        ...
        (e = this.settings.offset.y), (i[this.settings.placement.from] =
        e + 'px'), this.settings.placement.align)) {
        case 'left':
        case 'right':
      ...
      this.$ele.css (i).addClass (this.settings.animate.enter), t.each (
        Array ('webkit-', 'moz-', 'o-', 'ms-', ''),
        function (t, e) {
          s.$ele[0].style[e + 'AnimationIterationCount'] = 1;
        }
      ), t (this.settings.element).append (this.$ele), this.settings
        .newest_on_top === !0 &&
        ((e =
          parseInt (e) +
          parseInt (this.settings.spacing) +
          this.$ele.outerHeight ()), this.reposition (e)), t.isFunction (
        s.settings.onShow
      ) && s.settings.onShow.call (this.$ele), this.$ele
        .one (this.animations.start, function () {
          n = !0;
        })
        .one (this.animations.end, function () {
          s.$ele.removeClass (
            s.settings.animate.enter
      ...
      if (
        ...
        var e = setInterval (function () {
          ...
          if (
            ...
            s.$ele.data ('notify-delay', t), s.$ele
              .find ('[data-notify="progressbar"] > div')
    ...
    close: function () {
      ...
      this.$ele
        ...
        .addClass (this.settings.animate.exit), s.reposition (e), t.isFunction (
        s.settings.onClose
      ) && s.settings.onClose.call (this.$ele), this.$ele
        .one (this.animations.start, function () {
          i = !0;
        })
        .one (this.animations.end, function () {
          t (
            this
          ).remove (), t.isFunction (s.settings.onClosed) && s.settings.onClosed.call (this);
        }), setTimeout (function () {
        i ||
          (s.$ele.remove (), s.settings.onClosed &&
    ...
    reposition: function (s) {
      ...
      this.settings.newest_on_top === !0 &&
        (n = this.$ele.prevAll (i)), n.each (function () {
        t (this).css (
          e.settings.placement.from,
          s
    ...
    'warning' === s && (s = 'danger'), 'undefined' == typeof s || 'all' === s
